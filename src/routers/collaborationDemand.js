...
router.get('/offer/:id/demands',auth,async (req,res)=>{
    try{
        ...
        for(demand of offer.collaborationDemands){
            ...
            finalDemands.push({message: demand.message,offer:demand.offer,from:user.toJSON()})
        }
...
//On vérifie que l'utilisateur a un email validé, qu'il n'a pas déjà répondu à l'annonce ou qu'il ne travaille pas encore dessus
