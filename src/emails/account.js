...
const sendPasswordResetEmail = (email,name,token)=>{
    ...
    sgMail.send({
        ...
        html : "Bonjour " + name + " ! <br> Vous avez demandé à réinitialiser votre mot de passe, veuillez suivre le lien suivant : <br>" + ' <a href="'+link+'">Réinitialiser mon mot de passe</a> <br> Si cette demande ne viens pas de vous, veuillez cliquer sur le lien et cliquer sur le bouton correspondant. <br>' + "L'équipe de Loko "
